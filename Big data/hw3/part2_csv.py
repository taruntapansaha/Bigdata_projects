...
if __name__ == "__main__":
    ...
    sc = SparkContext(appName="Percentage_Delay_CSVFile")
    ...
    lines = sc.textFile(sys.argv[1]).map(airlineTuple)

    dataFrame=sqlContext.createDataFrame(lines, ['Year', 'Month', 'DayofMonth', 'DayOfWeek', 'DepTime', 'CRSDepTime', 'ArrTime',
